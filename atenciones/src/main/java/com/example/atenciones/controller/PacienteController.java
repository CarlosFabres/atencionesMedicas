...
public class PacienteController {
    ...
    public ResponseEntity<Object> createPaciente(@RequestBody Paciente paciente){
        ...
        // Si todos los campos necesarios están presentes, llamar al servicio para crear el paciente
    ...
    public ResponseEntity<Object> createHistorial(@PathVariable("idPaciente") Long idPaciente, @RequestBody HistorialMedico historial) {
